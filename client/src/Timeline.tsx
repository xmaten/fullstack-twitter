...
import { GetTimelineTweetsQueryResult, useGetTimelineTweetsQuery } from './generated/graphql';
...
const Timeline: React.FC<TimelineProps> = ({
  ...
  const { loading, error, data } = useGetTimelineTweetsQuery() as GetTimelineTweetsQueryResult
